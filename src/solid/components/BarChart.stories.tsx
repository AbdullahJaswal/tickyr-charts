...
// ─── borderWidth + visualStyle Outline interaction ──────────────────
//
...
// ─── Pattern fills (16 presets, scale, color) ──────────────────────

export const PatternDiagonalLines: Story = {
  args: { pattern: "diagonal-lines" },
}
export const PatternDiagonalLinesReverse: Story = {
  args: { pattern: "diagonal-lines-reverse" },
}
export const PatternCrossHatch: Story = {
  args: { pattern: "cross-hatch" },
}
export const PatternDots: Story = {
  args: { pattern: "dots" },
}
export const PatternCircles: Story = {
  args: { pattern: "circles" },
}
export const PatternGrid: Story = {
  args: { pattern: "grid" },
}
export const PatternHorizontalLines: Story = {
  args: { pattern: "horizontal-lines" },
}
export const PatternVerticalLines: Story = {
  args: { pattern: "vertical-lines" },
}
export const PatternPlus: Story = {
  args: { pattern: "plus" },
}
export const PatternChevron: Story = {
  args: { pattern: "chevron" },
}
export const PatternZigzag: Story = {
  args: { pattern: "zigzag" },
}
export const PatternWaves: Story = {
  args: { pattern: "waves" },
}
export const PatternCheckerboard: Story = {
  args: { pattern: "checkerboard" },
}
export const PatternHexagons: Story = {
  args: { pattern: "hexagons" },
}
export const PatternBricks: Story = {
  args: { pattern: "bricks" },
}
export const PatternScaleConfig: Story = {
  args: {
    pattern: { type: "diagonal-lines", scale: 2.5, lineWidth: 1.4 },
  },
}
