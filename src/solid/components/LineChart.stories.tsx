...
export const StaleBannerCustomComponent: Story = {
  args: {
    connectionState: "disconnected",
    staleVisualization: "banner",
    staleBanner: ({ state }: { state: string }) => (
      <div
        style={{
          background: "#1a1a1a",
          color: "#ff6b6b",
...
const glowDataUp = syntheticTrend(99, 180, 0.002)

export const GlowOff: Story = {
  args: {
    glow: "off",
    lineWidth: 2.5,
    data: glowDataUp,
...
export const GlowIntense: Story = {
  args: {
    glow: "intense",
    lineWidth: 2.5,
    data: glowDataUp,
...
export const GlowNumeric40: Story = {
  args: {
    glow: 0.4,
    lineWidth: 2.5,
    data: glowDataUp,
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Numeric `glow` input clamps to [0,1]; 0.4 sits between `subtle` (0.30) and `standard` (0.60).",
      },
    },
  },
}

export const GlowFastModeForcesOff: Story = {
  args: {
    glow: "intense",
    fastMode: true,
    lineWidth: 2.5,
  ...
  parameters: {
    docs: {
      description: {
        story:
          "`fastMode` forces `glow` to off regardless of input - extra GPU work isn't worth it on weak devices.",
      },
    },
  },
}
